...
const Sppinner = ({path="login"}) => {
  ...
  return (
    ...
    <div role="status "className='d-flex flex-column justify-content-center align-items-center' style={{height:'100vh'}}>
    <div>
    ...
    <span class="sr-only">{count}Loading...</span>
    </div>
